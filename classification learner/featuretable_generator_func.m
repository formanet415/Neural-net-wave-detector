function ft = featuretable_generator_func(cdf,n_samples,etype,indexes,classon)
%FEATURETABLE_GENERATOR Summary of this function goes here
...
if classon == 1
    ...
    ft = table(meanValueY,meanValueZ,medianValueY,medianValueZ,stdY,stdZ,madY,madZ,quantile25Y,quantile25Z,quantile75Y,quantile75Z,iqrY,iqrZ,minvalY,minvalZ,maxvalY, maxvalZ,separationY, separationZ,fpeakValY,fpeakValZ,fpeakFrqY,fpeakFrqZ,sampleSkewnessY,sampleSkewnessZ);
end
end
